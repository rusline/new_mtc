...
_ga.trackMailRu = function (opt_pageUrl, opt_trackerName) {
    var trackerName = _ga.buildTrackerName_(opt_trackerName);
    try {
        if (mailru && mailru.events && mailru.events.listen) {
            mailru.events.listen(mailru.plugin.events.liked, function (event, params) {
                ...
                if (button_type) {
                    _gaq.push(['_trackSocial', button_type, 'like']);
                }
            });
            mailru.events.listen(mailru.plugin.events.unliked, function (event) {
                _gaq.push(['_trackSocial', 'mm', 'unlike']);
            });
        }
    } catch (e) { }
};

_ga.trackLJ = function () {
    _gaq.push(['_trackSocial', 'livejournal', 'subject']);
};

_ga.trackYa = function () {
    _gaq.push(['_trackSocial', 'yandex', 'addlink']);
};

_ga.trackPageview = function (alias) {
